...
### Profiling Basic Tooling
- (COULD, LATER, MEDIUM, LARGE) 
- PENDING

Execution Speed Benchmark Framework. Execution Memory Metrics Report. Memory Dump?

### Profiling Detailed Tooling and Report 
...
Render the parsed AST as a Graphviz `.dot` graph, one per source file.
Perhaps optionally one combined graph for the whole program including imports.
